...
## Dataset
The project uses the **AG News dataset**, a widely used public benchmark for text classification.
...
This workflow mirrors common **enterprise NLP pipelines**, including:
